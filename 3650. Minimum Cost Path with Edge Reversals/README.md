...
<h3>Minimum Cost Path with Edge Reversals</h3>
<div><p>You are given a directed, weighted graph with <code>n</code> nodes labeled from 0 to <code>n - 1</code>, and an array <code>edges</code> where <code>edges[i] = [u<sub>i</sub>, v<sub>i</sub>, w<sub>i</sub>]</code> represents a directed edge from node <code>u<sub>i</sub></code> to node <code>v<sub>i</sub></code> with cost <code>w<sub>i</sub></code>.</p>
...
<p><strong><img alt="" src="assets/8a61a2e0e93a4db9b69e7f6c3e478030.png" style="width: 171px; height: 111px;"/></strong></p>
<ul>
