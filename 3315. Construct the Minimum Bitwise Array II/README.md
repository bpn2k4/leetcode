...
<h3>Construct the Minimum Bitwise Array II</h3>
<div><p>You are given an array <code>nums</code> consisting of <code>n</code> <span class="cursor-pointer relative text-dark-blue-s text-sm" data-keyword="prime-number"><button aria-controls="radix-:r1n:" aria-expanded="false" aria-haspopup="dialog" class="" data-state="closed" type="button">prime</button></span> integers.</p>
