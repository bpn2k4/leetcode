...
<h3>Find X Value of Array II</h3>
...
<p>A <strong>prefix</strong> of an array is a <span class="cursor-pointer relative text-dark-blue-s text-sm" data-keyword="subarray"><button aria-controls="radix-_r_u_" aria-expanded="false" aria-haspopup="dialog" class="" data-state="closed" type="button">subarray</button></span> that starts from the beginning of the array and extends to any point within it.</p>
<p>A <strong>suffix</strong> of an array is a <span class="cursor-pointer relative text-dark-blue-s text-sm" data-keyword="subarray"><button aria-controls="radix-_r_v_" aria-expanded="false" aria-haspopup="dialog" class="" data-state="closed" type="button">subarray</button></span> that starts at any point within the array and extends to the end of the array.</p>
