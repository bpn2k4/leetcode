...
<h3>Minimum Number of Seconds to Make Mountain Height Zero</h3>
<div><p>You are given an integer <code>mountainHeight</code> denoting the height of a mountain.</p>
