...
<h3>Minimum Jumps to Reach End via Prime Teleportation</h3>
...
<li><strong>Prime Teleportation</strong>: If <code>nums[i]</code> is a <span class="cursor-pointer relative text-dark-blue-s text-sm" data-keyword="prime-number"><button aria-controls="radix-_r_1j_" aria-expanded="false" aria-haspopup="dialog" class="" data-state="closed" type="button">prime number</button></span> <code>p</code>, you may instantly jump to any index <code>j != i</code> such that <code>nums[j] % p == 0</code>.</li>
</ul>
