...
<h3>Minimum Absolute Difference in Sliding Submatrix</h3>
<div><p>You are given an <code>m x n</code> integer matrix <code>grid</code> and an integer <code>k</code>.</p>
