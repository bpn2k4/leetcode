...
<h3>Count the Number of Computer Unlocking Permutations</h3>
<div><p>You are given an array <code>complexity</code> of length <code>n</code>.</p>
...
<p>Find the number of <span class="cursor-pointer relative text-dark-blue-s text-sm" data-keyword="permutation-array"><button aria-controls="radix-:r1v:" aria-expanded="false" aria-haspopup="dialog" class="" data-state="closed" type="button">permutations</button></span> of <code>[0, 1, 2, ..., (n - 1)]</code> that represent a valid order in which the computers can be unlocked, starting from computer 0 as the only initially unlocked one.</p>
