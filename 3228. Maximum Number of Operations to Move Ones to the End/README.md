...
<h3>Maximum Number of Operations to Move Ones to the End</h3>
<div><p>You are given a <span class="cursor-pointer relative text-dark-blue-s text-sm" data-keyword="binary-string"><button aria-controls="radix-:r1n:" aria-expanded="false" aria-haspopup="dialog" class="" data-state="closed" type="button">binary string</button></span> <code>s</code>.</p>
