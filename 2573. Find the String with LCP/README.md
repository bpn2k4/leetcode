...
<h3>Find the String with LCP</h3>
<div class="HTMLContent_html__0OZLp" data-track-load="description_content"><p>We define the <code>lcp</code> matrix of any <strong>0-indexed</strong> string <code>word</code> of <code>n</code> lowercase English letters as an <code>n x n</code> grid such that:</p>
<ul>
